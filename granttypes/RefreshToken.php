<?php
namespace minhhoit\oauth2\granttypes;

use minhhoit\oauth2\models\AccessToken;
use minhhoit\oauth2\models\BaseModel;
...
class RefreshToken extends BaseModel
{
    ...
    public function getResponseData()
    {
        ...
        $refreshToken = \minhhoit\oauth2\models\RefreshToken::createRefreshToken([
            'client_id' => $this->client_id,
            'user_id' => $refreshToken->user_id,
    ...
    /**
     *
     * @return \minhhoit\oauth2\models\RefreshToken
     */
    public function getRefreshToken()
    {
        if (is_null($this->_refreshToken)) {
            ...
            if (!$this->_refreshToken = \minhhoit\oauth2\models\RefreshToken::findOne(['refresh_token' => $this->refresh_token])) {
